...
"""
LOW_FREQUENCY_RETRIEVAL_SPEED = 1
HIGH_FREQUENCY_RETRIEVAL_SPEED = 1
SPI_FREQUENCY_HERCULES = 2000000

BRAKE_PIN = 21
COMMAND_PIN = "NOT SET"
LOW_FREQUENCY_PIN = "NOT SET"
HIGH_FREQUENCY_PIN = "NOT SET"

ZPACKET = [0x00, 0x00]
MASTER_PREFIX = [0x0A, 0xAA]
HIGH_FREQUENCY_PACKET_LENGTH = 5
LOW_FREQUENCY_PACKET_LENGTH = 120
...
def initialize_GPIO():
    ...
    gpio.output(COMMAND_PIN, True)
    gpio.output(LOW_FREQUENCY_PIN, True)
    gpio.output(HIGH_FREQUENCY_PIN, True)
