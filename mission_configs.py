...
"""
LOW_FREQUENCY_RETRIEVAL_SPEED = 2
HIGH_FREQUENCY_RETRIEVAL_SPEED = 2
...
CHIP_SELECT_HIGH_FREQUENCY = [(CS0, False), (CS1, True), (CS2, False)]
CHIP_SELECT_LOW_FREQUENCY = [(CS0, True), (CS1, True), (CS2, False)]

ZPACKET = [0x00, 0x00]
MASTER_PREFIX = [0x0A, 0xAA]
HIGH_FREQUENCY_PACKET_LENGTH = 4
LOW_FREQUENCY_PACKET_LENGTH = 119
